...
export const Persons=()=>{
  ...
  return <section className="exact-react-page">
    ...
    <Modal open={!!person} title={person?.isNew?'Add person':`Edit ${personName(person)}`} onClose={()=>setPerson(null)} actions={<><button className="btn" onClick={()=>setPerson(null)}>Back</button><button className="btn primary" disabled={save.isPending} onClick={()=>save.mutate()}>Save person</button></>}>
