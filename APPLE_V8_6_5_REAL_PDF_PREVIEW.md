...
- Replaces the fake Export A4 preview card with the actual generated PDF.
- Adds POST `/api/export/preview/{format}`.
- Preview uses the current unsaved A4 settings without writing them to the database.
